...
#         else:
#             await ctx.send("Enter channel name after $join (channel name)")
#
...
#         else:
#             await ctx.send("Please enter song link")
#
#     # @commands.command()
...
#         embed = discord.Embed(title="Now playing",
#                               description=f"adjusting volume to:{volume}",
#                               colour=0xa62019)
#         await ctx.send(embed=embed)
#
#     @commands.command()
...
class Music(commands.Cog):
    ...
    @commands.command(name='remove', aliases=['rem'], description="removes specified song from queue")
